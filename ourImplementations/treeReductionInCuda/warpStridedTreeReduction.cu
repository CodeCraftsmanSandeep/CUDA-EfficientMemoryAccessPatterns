...
template <const int block_size_power>
__global__ void treeReductionWarpStridedKernel (const unsigned int N, const int* __restrict__ a, long long int* __restrict__ total_sum){
    #define number_of_chuncks (N >> warp_size_power)
    #define number_of_warps   (gridDim.x << (block_size_power - warp_size_power))
    #define chuncks_per_warp  (number_of_chuncks / number_of_warps)
...
long long int computeReduction(const unsigned int N, const int* d_a)
{
    ...
    {
        treeReductionWarpStridedKernel       <block_size_256_power>
    ...
    {
       treeReductionWarpStridedKernel       <block_size_512_power> 
